...
// https://github.com/SineYlo/transfer-elements/blob/main/readme-ru.md

// **************************************** HTML ********************************************
//
//  <div id="id-1">Содержимое ПЕРВОЕ</div>
//  <div id="id-2">Содержимое ВТОРОЕ</div>

//  <div id="placeForTransfer" style="border: 1px red solid; padding: 1rem;">
//      <div>Элемент 1 [0]"</div>
//      <div>Элемент 2 [1]"</div>
//      <div>Элемент 3 [3]"</div>
//  </div>
...
// ***************************************** JS import ***************************************
//
// import TransferElements from './wl-classes/wl-transfer-elements.js';
// const newTransferElement = document.getElementById('id-1');
// if (newTransferElement) {
//   new TransferElements(  
//     {
//       sourceElement: newTransferElement,
//       breakpoints: {
//         990: {
//           targetElement: document.getElementById('placeForTransfer'),
//           targetPosition: 1
//           // индекс каким будет вмонтирован элемент в TargetElement если в нем есть другие елементыб
//           // если индекс больше чем кол-во эл-тов то он не отобразиться (внимательно !)
//         }
//       }
//     }   
//   )
...
export default class TransferElements {
