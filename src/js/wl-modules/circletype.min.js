// Создаем шаблон для текста с закруглением
// *** Коефициент для растояния между буквами на 914 строке

export default class textStampAround {
	constructor(options) {
		this.wordTop = new CircleType(document.querySelector(options.wordTopEl));
		this.wordBottom = new CircleType(document.querySelector(options.wordBottomEl));
		this.wordTop.radius(options.radius);
		this.wordBottom.radius(options.radius);
		this.wordBottom.dir(-1);
	}
}
		...
		function (t, n, e) {
			...
			t.exports =
				...
				function (t, n) {
					var e;
					return (
						null !== t ? ((c.prototype = r(t)), (e = new c()), (c.prototype = null), (e[u] = t)) : (e = a()),
						void 0 === n ? e : i(e, n)
					);
				};
		},
							...
							},
							{
								...
								value: function () {
									var t = this,
										...
										i = "center ".concat((r * 0.65) / this._fontSize, "em"),
