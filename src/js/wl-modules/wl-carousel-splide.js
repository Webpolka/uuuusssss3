...
export default function carousel(options) {
  ...
  (function (global, factory) {
    ...
    var PATH = "M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z";
    var SIZE = 16;
  ...
  const splide = new Splide(options.element, {
    ...
    speed: 500,         // скорость перелистывания в м\сек
    rewindSpeed: 500,   // скорость перемотки слайдов
    ...
    // --------------------------- НАСТРОЙКА ТУМБНЭЙЛОВ ---------------------------------
    var thumbnails = document.querySelectorAll(options.thumb);
    var current;
